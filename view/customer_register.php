        ...
        <div class="frame">
            <div class="login">
                ...
                <div class="login__header">
                    <div class="login__header--cont">
                        <span class="back-button">
                            <i class="fas fa-chevron-left"><a href="login.php"> Back</a></i>
                        </span>
                        <span class="logo">
                ...
                <div class="login__content">
                    ...
                    <h3 class="login--title">Customer Registration</h3>
                    <form action="../controller/register-controller.php" method="POST" class="login--form">


                        <div class="input--item">
                            <div class="js-input__content input__content has-error">
                                <input type="text" class="form__input js-input js-input-error" placeholder="Name" name="name" required>
                            </div>
                        </div>
                         <div class="input--item">
                            <div class="js-input__content input__content has-error">
                                <input type="email" class="form__input js-input js-input-error" placeholder="Email" name="email" required>
                            </div>
                        </div>
                       
                         <div class="input--item">
                            <div class="js-input__content input__content has-error">
                                <input type="text" class="form__input js-input js-input-error" placeholder="Mobile" name="mobile_number" required>
                            </div>
                        </div>
                          <div class="input--item">
                            <div class="js-input__content input__content has-error">
                           ...
                           <button class="login--button" name="register">Register</button>
                    ...
                    <div class="login__pagination">
                          You have'nt Account<a href="register_customer" style="color:blue;"> Create an Account</button>
                    </div>
                </div>
            </div>
        </div>
